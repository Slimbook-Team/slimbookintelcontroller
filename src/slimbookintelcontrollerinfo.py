...
class PreferencesDialog(Gtk.Window):
    def __init__(self):
        ...
        info.set_markup(
            "<span>{}</span>".format(
                _(
                    "The Slimbook Intel Controller app is capable of setting several TDP "
        ...
        info2 = Gtk.Label()
        info2.set_markup(
            "<span>{}<a href='https://www.patreon.com/slimbook'> patreon </a>{}</span>".format(
                _(
                    "If you want to support the Slimbook team with the development of this app and several more to come, "
        ...
        info3.set_markup(
            "<span><b>{}</b>{}</span>".format(
                _("Note: "),
                _(
                    "Many laptops limit the power of the CPU, when working without the charger connected. "
        ...
        twitter = Gtk.Label()
        twitter.set_markup(
            "<span><b><a href='https://twitter.com/SlimbookEs'>@SlimbookEs</a></b>    </span>"
        )
        ...
        facebook = Gtk.Label()
        facebook.set_markup(
            "<span><b><a href='https://www.facebook.com/slimbook.es'>slimbook.es</a></b>    </span>"
        )
        ...
        instagram = Gtk.Label()
        instagram.set_markup(
            "<span><b><a href='https://www.instagram.com/slimbookes'>@slimbookes</a></b></span>"
        )
        ...
        label77 = Gtk.LinkButton(
            uri=tutorial_link, label=_("@SlimbookIntelController Tutorial")
        )
        label77.set_halign(Gtk.Align.CENTER)
        link_box2.add(label77)

        label77 = Gtk.LinkButton(
            uri="https://github.com/slimbook/slimbookintelcontroller/tree/developing/src/translations",
        ...
        email = Gtk.Label()
        email.set_markup(
            "<span><b>" + _("Send an e-mail to: ") + "dev@slimbook.es</b></span>"
        )
        ...
        github = Gtk.LinkButton(
            uri="https://github.com/slimbook/slimbookintelcontroller"
        )
