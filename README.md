...
If you want to try the software in any other CPU, you can add it to the configuration file  /home/<user>/.config/slimboookintelcontroller/slimbookintelcontroller.conf
