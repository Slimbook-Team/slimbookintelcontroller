...
class PreferencesDialog(Gtk.Window):
    ...
    # Enlaces --------------------------------------------------------------------------
        ...
        tutorial_link=''
        if entorno_usu.find('es') >= 0:
            tutorial_link = 'https://slimbook.es/es/tutoriales/aplicaciones-slimbook/493-slimbook-intel-controller'
        else:
            tutorial_link = 'https://slimbook.es/en/tutoriales/aplicaciones-slimbook/494-slimbook-intel-controller-en'
